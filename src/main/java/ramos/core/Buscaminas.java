...
public class Buscaminas {
	 ...
	 * 
	 * @param x
	 *            Ancho del tablero (Nmero de columnas).
	 * @param y
	 *            Alto del tablero (Nmero de filas).
	 * @param minas
	 *            Nmero de minas
	 * @param vidas
	 *            Nmero de errores permitidos.
	 * @throws DemasiadasMinasException
	 *             Esta excepcin debe ser capturada para saber si ha sido
	 *             posible construir el tablero dado su tama o y n mero de
	 *             minas. No se puede crear un tablero con m s minas que
	 *             casillas disponibles. En caso de intentar crearlo, el objeto
	 *             no se crear , y lanzar  esta excepci n.
	 * @throws NumeroDeVidasFueraDeRangoException
	 *             Esta excepci n se lanza cuando trates de crear un nuevo juego
	 *             con un n mero de vidas superior o inferior al n mero de
	 *             minas.
	 */
	 ...
	 * minas. Por tanto, el usuario tendr  tantas oportunidades como minas
	 * halla.
	 * 
	 * @param x
	 ...
	 * @param minas
	 *            N mero de minas que tendr  el tablero.
	 * @throws DemasiadasMinasException
	 * @throws NumeroDeVidasFueraDeRangoException
	 */
	...
	/**
	 * Este m todo es privado, porque ni el usuario ni la interfaz tienen por
	 * qu  conocerlo ni utilizarlo. Sirve de forma interna para situar las minas
